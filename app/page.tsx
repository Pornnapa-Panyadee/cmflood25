        ...
        <div className="mx-auto flex min-h-[calc(100vh-8rem)] max-w-6xl flex-col justify-center">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="text-3xl font-bold leading-tight text-slate-900 sm:text-4xl lg:text-5xl">
              ระบบการเตือนภัยและแนวทางการป้องกัน<br></br>น้ำท่วมในเขตเมือง จังหวัดเชียงใหม่
            </h1>
          </div>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2">
            ...
            >
              ...
              <h2 className="text-2xl font-semibold text-slate-900">โครงการย่อย 1 : <br></br>ระบบเตือนภัยน้ำท่วมเขตเมือง จังหวัดเชียงใหม่ </h2>
            </Link>
            ...
            >
              <div className="mb-5 h-1.5 w-20 rounded-full bg-blue-500" />
              <h2 className="text-2xl font-semibold text-slate-900">โครงการย่อย 2 : <br></br>ระบบติดตามโครงการแก้ไขปัญหาน้ำท่วมเขตเมืองจังหวัดเชียงใหม่</h2>
            </Link>
          </div>
        </div>
      </main>
