...
export default function WaterDashboard() {
  ...
  const galleries = [
    ...
    },
    {
      ...
      description:
        "เสาหลักมีช่องบอกค่าตัวเลขระดับน้ำต่างๆ ที่จะเข้าท่วมพื้นที่ โดยเทียบกับค่าระดับน้ำปิงที่สถานี P.1 สะพานนวรัฐ เมื่อทราบค่าพยากรณ์ระดับน้ำปิงที่ P.1 ให้นำตัวเลขนั้นมาเทียบกับตัวเลขบนหลัก ก็จะทรายความสูงระดับน้ำที่จะท่วมบริเวณที่มีหลักวางอยู่",
      link: "/pole2025",
      images: [
    ...
    {
      id: 5,
      name: "ครื่องหมายระดับน้ำท่วมเขตเมือง จ.เชียงใหม่ ปี 2567",
      description:
