            ...
            <Card className="h-full border border-blue-100 shadow-sm">
              ...
              <CardContent>
                ...
                <p className="list-disc list-inside space-y-2 text-sm text-gray-700 mt-[5px] ">
                  ...
                  ซึ่งเป็นวิธีการถ่วงน้ำหนักตามระยะทางระหว่างจุดข้อมูล ช่วยให้สามารถสร้างค่าความลึกของน้ำท่วมในบริเวณที่ไม่มีข้อมูลจริงให้มีความต่อเนื่องและสอดคล้องกับลักษณะทางภูมิประเทศ สำหรับชุดข้อมูลบนแผนที่แบ่งเป็น 3 แบบ ได้แก่
                </p>
                ...
                <p className="list-disc list-inside space-y-2 text-sm text-gray-700"> 
                  2) แผนที่ระดับความลึก (ม.รทก.) โดยแสดงค่าระดับเชิงความสูงของผิวน้ำในระบบ ม.รทก. เพื่อใช้เปรียบเทียบระดับน้ำเชิงพื้นที่
                </p>
                <p className="list-disc list-inside space-y-2 text-sm text-gray-700"> 
                  3) แผนที่ช่วงความลึกน้ำท่วม โดยการแสดงความลึกของน้ำท่วมเป็นช่วงความลึก และใช้สีที่แตกต่างกันในแต่ละช่วงความลึก
                </p>
              ...
              <CardContent>
                <p className="list-disc list-inside space-y-2 text-sm text-gray-700">
                  ...
                  2) เลือกชั้นข้อมูลจากเมนูมุมขวาบน เช่น ความลึกน้ำท่วม, ระดับความลึก (ม.รทก.), หรือช่วงความลึกน้ำท่วม <br />
                  3) ดูค่าที่จุดนั้นตามชั้นข้อมูลที่เปิดอยู่ <br />
                  4) ซูมและเลื่อนแผนที่ได้ตามต้องการ
                </p>
              </CardContent>
