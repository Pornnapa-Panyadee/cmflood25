    ...
    <div className="min-h-screen bg-background">
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-10">
        ...
        <div className="mb-10 text-center">
          <h3 className="text-2xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-foreground">
              ...
              <CardHeader className="border-b">
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="flex justify-start md:justify-end">
                    ...
                    >
                      <Button
                        className="h-auto rounded-xl px-4 py-2 text-base sm:text-lg font-semibold shadow-md"
                        variant="default"
                      >
                        แผนที่เสี่ยงภัยน้ำท่วมเขตเมือง จังหวัดเชียงใหม่ (พ.ศ. 2557)
                      </Button>
                    </Link>
                  </div>
                </div>
